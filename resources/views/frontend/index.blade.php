                ...
                <div class="col-lg-6">
                    <div class="left-content">
                        <div class="thumb">
                            ...
                            <img src="{{asset('frontend/images/left-banner-image.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="first-image">
                                    <img src="{{asset('frontend/images/explore-image-01.jpg')}}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="second-image">
                                    <img src="{{asset('frontend/images/explore-image-02.jpg')}}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="types">
            ...
            <div class="row images">
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{asset('frontend/images/instagram-01.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{asset('frontend/images/instagram-02.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{asset('frontend/images/instagram-03.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{asset('frontend/images/instagram-04.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                ...
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{asset('frontend/images/instagram-06.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
